...
public class Drive extends Subsystem {
    ...
    public enum LiftLockState {LOCKED, UNLOCKED, BUTTON}
    public NavX navX;
    ...
    public void setLiftLock(LiftLockState state) {
        if (state == LiftLockState.BUTTON) {
            liftLock.set(!liftLock.get());

        } else {
            liftLock.set(state == LiftLockState.LOCKED);
        }
    }
